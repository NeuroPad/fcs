...
class ContradictionAnalysis(BaseModel):
    """Analysis of contradictions between nodes."""
    ...
    contradiction_type: str = Field(
        ...,
        description='Type of contradiction detected (e.g., "preference_change", "factual_contradiction")',
    )
    contradiction_description: str = Field(
        ...,
        description='Human-readable description of the contradiction',
    )
    requires_alternative: bool = Field(
        ...,
        description='Whether this type of contradiction requires an alternative to be specified',
    )
    alternative_provided: bool = Field(
        ...,
        description='Whether an alternative was provided in the new node',
    )
    metadata: dict[str, Any] = Field(
        default_factory=dict,
        description='Additional metadata about the contradiction',
    )
...
def get_contradiction_prompt(context: dict[str, Any]) -> list[Message]:
    """
    Get the contradiction analysis prompt.
    
    Parameters
    ----------
    context : dict[str, Any]
        Context for the contradiction analysis
